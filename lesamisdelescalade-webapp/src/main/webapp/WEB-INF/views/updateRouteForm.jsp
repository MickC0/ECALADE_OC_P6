...
<div class="container">
    ...
    <div>
        ...
        <form:form modelAttribute="routeToUpdate" method="post" action="updatingRouteProcess/${routeToUpdate.id}">
            <table>
                <tr>
                    <td><form:hidden path="id" value="${routeToUpdate.id}"/></td>
                    <td><form:errors path="id" cssClass="errors"/></td>
                </tr>
                <tr>
                    <td><form:hidden path="sector.id" value="${routeToUpdate.sector.id}"/></td>
                    <td><form:errors path="sector.id" cssClass="errors"/></td>
                </tr>
                <tr>
                    <!-- display for "nomSite" -->
                    <td> Nom de la voie:* </td>
                    <td><form:input path="name" value="${routeToUpdate.name}" type="text"  id="name" size="20" placeholder="obligatoire"  cssStyle=""/></td>
                    <td><form:errors path="name" cssClass="errors"/></td>
                </tr>
                <tr>
                    <!-- display for "descriptionSite" -->
                    <td>Description de la voie:</td>
                    <td><form:input path="description" value="${routeToUpdate.description}" type="text" id="description" size="40" placeholder=""  cssStyle=""/></td>
                    <td><form:errors path="description" cssClass="errors"/></td>
                </tr>
                <tr>
                    <!-- display for "descriptionSite" -->
                    <td>Cotation de la voie:</td>
                    <td><form:input path="cotation" value="${routeToUpdate.cotation}" type="text" id="cotation" size="40" placeholder=""  cssStyle=""/></td>
                    <td><form:errors path="cotation" cssClass="errors"/></td>
                </tr>
                <tr>
                    <!-- display for "descriptionSite" -->
                    <td>Hauteur de la voie:</td>
                    <td><form:input path="height" value="${routeToUpdate.height}" type="number" id="height" size="40" placeholder=""  cssStyle=""/></td>
