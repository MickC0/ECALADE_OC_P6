    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form:form modelAttribute="routeToUpdate" method="post" action="updatingRouteProcess/${routeToUpdate.id}">
                ...
                <div class="form-group">
                    <form:input path="description" type="text" value="${routeToUpdate.description}" cssClass="form-control item" placeholder="Description de la voie" required="true" autofocus=""/>
