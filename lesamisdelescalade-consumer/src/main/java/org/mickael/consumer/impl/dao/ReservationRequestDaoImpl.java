...
public class ReservationRequestDaoImpl extends AbstractDao implements ReservationRequestDao {
    ...
    public ReservationRequest findReservationRequestByGuidebookId (Integer id) {
        ...
        ReservationRequest reservationRequest = getNamedParameterJdbcTemplate().queryForObject(sql, parameterSource, reservationRequestRowMapper);
    ...
    public List<ReservationRequest> findAllReservationRequest() {
        ...
        ReservationRequestRowMapper reservationRequestRowMapper = new ReservationRequestRowMapper();
        List<ReservationRequest> reservationRequestList = getJdbcTemplate().query(sql, reservationRequestRowMapper);
